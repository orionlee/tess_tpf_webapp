...
class ExtendedGaiaDR3TICInteractSkyCatalogProvider(GaiaDR3TICInteractSkyCatalogProvider):
    ...
    def get_detail_view(self, data: dict) -> Tuple[dict, list]:
        ...
        extra_rows.append(
            f'<a href="{gaia_xmatch_var_url}" target="_blank">Gaia DR3 XMatch Variables by coordinate</a> [2023A&A...674A..22G]'
        )
        ...
        extra_rows.append(
            f'<a href="{gaia_dispersions_url}" target="_blank">Gaia DR3 Stellar Variability by coordinate</a> [2023A&A...677A.137M]'
        )
